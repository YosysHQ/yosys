...
module FIFO_8K_BLK (
  ...
  parameter data_depth_int = 512, data_width_int = 16, reg_rd_int = 0, sync_fifo_int = 0;
...
module FIFO_16K_BLK (
  ...
  parameter data_depth_int = 512, data_width_int = 32, reg_rd_int = 0, sync_fifo_int = 0;
